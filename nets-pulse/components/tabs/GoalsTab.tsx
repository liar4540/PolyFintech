  ...
  return (
    <div className="flex flex-col gap-4 pb-6 relative">
      ...
      <div className="flex items-center justify-between pt-2">
        ...
        <button className="w-10 h-10 rounded-2xl flex items-center justify-center" style={{ background: "#7C3AED" }}>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #1a0840 0%, #0f1a30 100%)",
          border: "1px solid rgba(124,58,237,0.2)",
        }}
      >
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-xl bg-[#7C3AED]/20 flex items-center justify-center text-xl">🎯</div>
          <div>
        ...
        <div className="w-full h-2 rounded-full" style={{ background: "rgba(255,255,255,0.08)" }}>
          <div
            ...
            style={{ width: `${totalPct}%`, background: "linear-gradient(90deg, #7C3AED, #10B981)" }}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {BADGES.map((b) => (
            <div
              ...
              style={{
                background: b.unlocked ? "rgba(124,58,237,0.1)" : "rgba(255,255,255,0.03)",
                border: b.unlocked ? "1px solid rgba(124,58,237,0.3)" : "1px solid rgba(255,255,255,0.05)",
            ...
            >
              ...
              {b.unlocked && <div className="w-full h-0.5 rounded-full" style={{ background: "linear-gradient(90deg, #7C3AED, #10B981)" }} />}
