  ...
  return (
    <div className="flex flex-col gap-4 pb-6">
      ...
      <div className="flex items-center justify-between pt-2">
        <div>
          ...
          <h1 className="text-white font-black text-2xl flex items-center gap-2">
            {USER.name} <span className="text-[#7C3AED]">✦</span>
          </h1>
        </div>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #2D1060 0%, #1a0840 60%, #0f1a30 100%)",
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, rgba(16,185,129,0.15), rgba(124,58,237,0.1))", border: "1px solid rgba(16,185,129,0.3)" }}
      >
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.12), rgba(16,185,129,0.08))", border: "1px solid rgba(124,58,237,0.2)" }}
      >
      ...
      <div className="glass rounded-3xl p-4 border border-white/5">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-[#7C3AED] text-xs font-semibold">This week</button>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-[#7C3AED] text-xs font-semibold">See all</button>
        </div>
